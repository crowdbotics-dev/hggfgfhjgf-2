"""
Django settings for hggfgfhjgf_2 project.
...
ROOT_URLCONF = 'hggfgfhjgf_2.urls'
...
WSGI_APPLICATION = 'hggfgfhjgf_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hggfgfhjgf_2 API",
    "DESCRIPTION": "API documentation for hggfgfhjgf_2 App",
    "VERSION": "v1",
}
